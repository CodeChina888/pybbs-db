...
CREATE TABLE `document` (
  ...
  `fullpath` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `system_config` VALUES (18, 'static_url', '', '静态文件访问地址，主要用于上传文件的访问，注意最后有个\"/\"', 25, 'url', NULL, 0);
...
INSERT INTO `system_config` VALUES (21, 'upload_path', '', '上传文件的路径，注意最后有个\"/\"', 25, 'text', NULL, 0);
